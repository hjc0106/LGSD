...
model = dict(
    ...
    distillation=dict(
        kd_type="backbone",
        loss_balance=[0.5, 0.5],
        local_cfg=dict(
            sg_layers = 2,
            num_samplings = [256, 128],  # [3000, 1500, 750]
            num_neighbors = [64, 32],  # [64, 32, 16]
    ...
    middle_encoder=dict(
        ...
        encoder_channels=((8, ), (16, 16, 16), (32, 32, 32), (32, 32, 32)), # ((16, ), (32, 32, 32), (64, 64, 64), (64, 64, 64))
